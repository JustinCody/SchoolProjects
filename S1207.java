...
{  
  public static void main(String[] args) throws 
                                             IOException
  {
    System.out.println("S1207 compiler written by Justin");
    ...
    outFile.println("; from S1207 compiler written by Justin");

    // construct objects that make up compiler
    S1207SymTab st = new S1207SymTab();
    S1207TokenMgr tm =  new S1207TokenMgr(inFile, outFile, debug);
    S1207CodeGen cg = new S1207CodeGen(outFile, st);
    S1207Parser parser = new S1207Parser(st, tm, cg);
...
//======================================================
class S1207TokenMgr implements S1207Constants
{
  ...
  //-----------------------------------------
  public S1207TokenMgr(Scanner inFile, 
...
}                                   // end of S1207TokenMgr
//======================================================
class S1207Parser implements S1207Constants
{
  private S1207SymTab st;
  private S1207TokenMgr tm;
  private S1207CodeGen cg;
  private Token currentToken;
  private Token previousToken; 
  //-----------------------------------------
  public S1207Parser(S1207SymTab st, S1207TokenMgr tm, 
                                           S1207CodeGen cg)
  {
    this.st = st;
    this.tm = tm;
...
class S1207CodeGen
{
  ...
  private S1207SymTab st;
  //-----------------------------------------
  public S1207CodeGen(PrintWriter outFile, S1207SymTab st)
  {
    this.outFile = outFile;
    this.st = st;
  }
